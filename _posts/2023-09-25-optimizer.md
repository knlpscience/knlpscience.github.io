...
- 테일러 급수의 2차 근사를 이용한 방법으로, $\dot{L}(W_{t+1})\approx \dot{L}(W_t)+\ddot{L}(W_t)\cdot (W_{t+1}-W_t)$ 이를 정리하면 아래와 같은 반복법을 유도할 수 있다.
...
- 따라서, 테일러 급수의 1차 근사 까지만 활용하여 Hessian 대신 학습률 $\eta$로 대체된 형태가 오늘날 경사하강법이 되겠다.
